...
#SBATCH --job-name=af3_c3_prod_xtnd
#SBATCH --output=output_resume_af3_c3_%j.out
#SBATCH --error=error_resume_af3_c3_%j.err
...
#
# Resumes an interrupted prod_md_af3_c3.sh run from its checkpoint, continuing
...
# --exclusive (matching prod_md_af3_c3.sh) -- this partition/qos rejects it
...
#
# Usage: sbatch resume_prod_af3_c3.sh
...
SEQ_DIR=/scratch/alpine/ivta1597/SH2/seeds/af3_c3
