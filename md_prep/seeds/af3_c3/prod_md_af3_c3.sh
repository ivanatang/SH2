...
#SBATCH --job-name=af3_c3_prod
#SBATCH --output=output_prod_af3_c3_%j.out
#SBATCH --error=error_prod_af3_c3_%j.err
...
MDP=$DIR/mdp
TOP=$DIR/seeds/af3_c3/gromacs/af3_c3_dodecahedron.top
...
# resume_prod_af3_c3.sh (unmodified, repeatedly) to continue to completion.
