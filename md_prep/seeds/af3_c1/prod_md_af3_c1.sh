...
#SBATCH --job-name=af3_c1_prod
#SBATCH --output=output_prod_af3_c1_%j.out
#SBATCH --error=error_prod_af3_c1_%j.err
...
# resume_prod_af3_c1.sh (unmodified, repeatedly) to continue to completion.
