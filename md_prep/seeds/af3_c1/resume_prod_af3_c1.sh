...
#SBATCH --job-name=af3_c1_prod_xtnd
#SBATCH --output=output_resume_af3_c1_%j.out
#SBATCH --error=error_resume_af3_c1_%j.err
...
#
# Resumes an interrupted prod_md_af3_c1.sh run from its checkpoint, continuing
...
# --exclusive (matching prod_md_af3_c1.sh) -- this partition/qos rejects it
...
#
# Usage: sbatch resume_prod_af3_c1.sh
