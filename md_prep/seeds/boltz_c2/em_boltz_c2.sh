...
#SBATCH --job-name=em_boltz_c2
#SBATCH --output=output_em_boltz_c2_%j.out
#SBATCH --error=error_em_boltz_c2_%j.err
...
gmx grompp -f $MDP/em.mdp \
  -c $DIR/seeds/boltz_c2/gromacs/boltz_c2_dodecahedron.gro \
  -p $TOP \
  -o em.tpr
gmx mdrun -deffnm em
