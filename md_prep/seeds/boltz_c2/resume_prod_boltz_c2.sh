...
#SBATCH --job-name=boltz_c2_prod_xtnd
#SBATCH --output=output_resume_boltz_c2_%j.out
#SBATCH --error=error_resume_boltz_c2_%j.err
...
#
# Resumes an interrupted prod_md_boltz_c2.sh run from its checkpoint, continuing
...
# --exclusive (matching prod_md_boltz_c2.sh) -- this partition/qos rejects it
...
#
# Usage: sbatch resume_prod_boltz_c2.sh
