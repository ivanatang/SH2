...
#SBATCH --job-name=af3_c2_prod
#SBATCH --output=output_prod_af3_c2_%j.out
#SBATCH --error=error_prod_af3_c2_%j.err
...
MDP=$DIR/mdp
TOP=$DIR/seeds/af3_c2/gromacs/af3_c2_dodecahedron.top
...
# resume_prod_af3_c2.sh (unmodified, repeatedly) to continue to completion.
