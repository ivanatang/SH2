...
#SBATCH --job-name=af3_c4_prod_xtnd
#SBATCH --output=output_resume_af3_c4_%j.out
#SBATCH --error=error_resume_af3_c4_%j.err
...
#
# Resumes an interrupted prod_md_af3_c4.sh run from its checkpoint, continuing
...
# --exclusive (matching prod_md_af3_c4.sh) -- this partition/qos rejects it
...
#
# Usage: sbatch resume_prod_af3_c4.sh
...
SEQ_DIR=/scratch/alpine/ivta1597/SH2/seeds/af3_c4
