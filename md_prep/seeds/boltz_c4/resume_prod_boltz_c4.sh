...
#SBATCH --job-name=boltz_c4_prod_xtnd
#SBATCH --output=output_resume_boltz_c4_%j.out
#SBATCH --error=error_resume_boltz_c4_%j.err
...
#
# Resumes an interrupted prod_md_boltz_c4.sh run from its checkpoint, continuing
...
# --exclusive (matching prod_md_boltz_c4.sh) -- this partition/qos rejects it
...
#
# Usage: sbatch resume_prod_boltz_c4.sh
