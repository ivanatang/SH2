...
#SBATCH --job-name=em_boltz_c4
#SBATCH --output=output_em_boltz_c4_%j.out
#SBATCH --error=error_em_boltz_c4_%j.err
...
gmx grompp -f $MDP/em.mdp \
  -c $DIR/seeds/boltz_c4/gromacs/boltz_c4_dodecahedron.gro \
  -p $TOP \
  -o em.tpr
gmx mdrun -deffnm em
